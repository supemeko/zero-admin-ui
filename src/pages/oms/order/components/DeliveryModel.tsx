...
const DeliveryModel: React.FC<UpdateFormProps> = (props) => {
  ...
  const { onSubmit, onCancel, deliveryModelVisible, currentData } = props;
  ...
  const renderContent = () => {
    return (
      <>
        ...
        <FormItem name="status" label="订单状态" initialValue={2} hidden>
  ...
  return (
    <Modal forceRender destroyOnClose title="发货信息" open={deliveryModelVisible} {...modalFooter}>
