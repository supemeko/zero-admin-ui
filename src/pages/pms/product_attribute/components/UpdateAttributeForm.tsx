    ...
    return (
      <>
        ...
        <FormItem
          name="name"
          label="规格/参数名称"
          rules={[{ required: true, message: '请输入规格/参数名称!' }]}
        >
        ...
        <FormItem
          name="filterType"
          label="分类筛选样式"
          rules={[{ required: true, message: '请选择分类筛选样式!' }]}
        >
          <Radio.Group>
        ...
        <FormItem
          name="searchType"
          label="能否进行检索"
          rules={[{ required: true, message: '请选择能否进行检索!' }]}
        >
          <Radio.Group>
        ...
        <FormItem
          name="relatedStatus"
          label="商品属性关联"
          rules={[{ required: true, message: '请选择商品属性关联!' }]}
        >
          <Radio.Group>
        ...
        <FormItem
          name="selectType"
          label="属性是否可选"
          rules={[{ required: true, message: '请选择属性是否可选!' }]}
        >
          <Radio.Group>
        ...
        <FormItem
          name="inputType"
          label="属性值的录入方式"
          rules={[{ required: true, message: '请选择属性值的录入方式!' }]}
        >
        ...
        {inputType === 1 && (
          <FormItem name="inputList" label="属性值可选值列表">
            <Input.TextArea
              rows={3}
              placeholder={'请输入属性值可选值列表,可选值列表，以逗号隔开'}
            />
          </FormItem>
        )}
        <FormItem
          name="handAddStatus"
          label="是否支持手动新增"
          rules={[{ required: true, message: '请选择是否支持手动新增!' }]}
        >
          <Radio.Group>
        ...
        <FormItem
          name="type"
          label="属性的类型"
          rules={[{ required: true, message: '请选择属性的类型!' }]}
        >
          <Radio.Group>
