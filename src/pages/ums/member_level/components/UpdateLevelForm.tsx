    ...
    return (
      <>
        ...
        <FormItem
          name="growthPoint"
          label="成长值"
          rules={[{ required: true, message: '成长值!' }]}
        >
        ...
        <FormItem
          ...
          label="每次评价获取的成长值"
          rules={[{ required: true, message: '每次评价获取的成长值!' }]}
        >
          <InputNumber addonAfter={'积分'} />
        </FormItem>
        <FormItem
          ...
          label="免运费标准"
          rules={[{ required: true, message: '免运费标准!' }]}
        >
        ...
        <FormItem
          name="defaultStatus"
          label="是否为默认等级"
          rules={[{ required: true, message: '是否为默认等级!' }]}
        >
        ...
        <FormItem
          ...
          label="免邮特权"
          rules={[{ required: true, message: '请选择免邮特权!' }]}
        >
        ...
        <FormItem
          ...
          label="签到特权"
          rules={[{ required: true, message: '请选择签到特权!' }]}
        >
        ...
        <FormItem
          ...
          label="评论获奖励特权"
          rules={[{ required: true, message: '请选择评论获奖励特权!' }]}
        >
        ...
        <FormItem
          ...
          label="专享活动特权"
          rules={[{ required: true, message: '请选择专享活动特权!' }]}
        >
        ...
        <FormItem
          ...
          label="会员价格特权"
          rules={[{ required: true, message: '请选择会员价格特权!' }]}
        >
        ...
        <FormItem
          ...
          label="生日特权"
          rules={[{ required: true, message: '请选择生日特权!' }]}
        >
