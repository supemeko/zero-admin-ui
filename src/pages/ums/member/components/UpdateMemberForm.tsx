  ...
  const renderContent = () => {
    return (
      <>
        ...
        <FormItem name="username" label="会员名">
        ...
        <FormItem name="integration" label="积分">
          <Input id="update-integration" placeholder={'请输入积分'} />
        </FormItem>

        <FormItem name="growth" label="成长值">
          <Input id="update-growth" placeholder={'请输入成长值'} />
        </FormItem>

        <FormItem name="luckeyCount" label="剩余抽奖次数">
          <Input id="update-luckeyCount" placeholder={'请输入剩余抽奖次数'} />
        </FormItem>

        <FormItem name="historyIntegration" label="历史积分数量">
