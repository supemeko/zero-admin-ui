  ...
  const renderContent = () => {
    return (
      <>
        ...
        <FormItem label="开始时间" rules={[{ required: true, message: '请输入开始时间!' }]}>
          <DatePicker
            value={moment(startTime, 'YYYY-MM-DD HH:mm:ss')}
            onChange={onChangeStartDate}
            showTime
            placeholder={'请输入开始时间'}
          />
        </FormItem>
        <FormItem label="结束时间" rules={[{ required: true, message: '请输入结束时间!' }]}>
          <DatePicker
